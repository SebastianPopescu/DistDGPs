...
from DGP.losses import *
from DGP.network_architectures import *
        ...
        for i in range(num_iterations):
            ...
            if i % 1000==0:
                ...
                for current_layer in range(num_layers):
                    ...
                    axis.legend(loc="upper right",prop={'size': 72})
...
if __name__=='__main__':
   ...
   # plt.scatter(x,y)
    ...
    main_DeepGP(num_data = x_values_training_np.shape[0], dim_input = x_values_training_np.shape[1], dim_output = 1,
        ...
        base_seed = 0, mean_Y_training = None, dataset_name = 'banana',
